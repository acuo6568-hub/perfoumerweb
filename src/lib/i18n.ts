...
export const translations = {
  az: {
    ...
    footer: {
      ...
      blog: "Blog",
      contactLink: "Əlaqə",
      exploreTitle: "Araşdır",
      exploreDescription: "Ətirlər, brendlər, kampaniyalar və faydalı səhifələri bir yerdə araşdırın.",
      categoriesTitle: "Kateqoriyalar",
      helpTitle: "Yardım və hüquqi",
      legalNoticeTitle: "Hüquqi bildiriş",
      legalNoticeDescription: "Müəlliflik hüququ, ticarət nişanları və platforma barədə qısa məlumat.",
      legalNoticeCopyright: "© 2020 — 2026 Bütün hüquqlar qorunur.",
      legalNoticeBrand: "Perfoumer müstəqil ətir kəşfi və alış platformasıdır.",
      legalNoticeTrademark: "Bütün brend adları, loqolar və şəkillər yalnız identifikasiya məqsədi ilə istifadə olunur.",
      websiteCredit: "Vebsayt tərəfindən hazırlanıb",
  ...
  en: {
    ...
    footer: {
      ...
      exploreDescription: "Discover perfumes, brands, offers, and useful pages in one place.",
      categoriesTitle: "Categories",
      helpTitle: "Help & legal",
      legalNoticeTitle: "Legal notice",
      legalNoticeDescription: "Copyright, trademarks, and platform information.",
      legalNoticeCopyright: "© 2020 — 2026 All rights reserved.",
      legalNoticeBrand: "Perfoumer is an independent perfume discovery and shopping platform.",
      legalNoticeTrademark: "All brand names, logos, and images are used for identification purposes only.",
      websiteCredit: "Website made by",
  ...
  ru: {
    ...
    footer: {
      ...
      exploreDescription: "Ароматы, бренды, акции и полезные страницы в одном месте.",
      categoriesTitle: "Категории",
      helpTitle: "Помощь и юридическая информация",
      legalNoticeTitle: "Юридическое уведомление",
      legalNoticeDescription: "Краткая информация об авторских правах, товарных знаках и платформе.",
      legalNoticeCopyright: "© 2020 — 2026 Все права защищены.",
      legalNoticeBrand: "Perfoumer — независимая платформа для выбора и покупки ароматов.",
      legalNoticeTrademark: "Все названия брендов, логотипы и изображения используются только для идентификации.",
      websiteCredit: "Сайт создан",
